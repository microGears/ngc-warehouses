 ...
 * @datetime 03.09.2024 12:24:00
 */
class CountryRecordset extends SearchRecordsetAbstract
{
    ...
    public function getQuery(): string
    {
        ...
        if ($query = $this->getSearchBuilder()) {
            $query
                ...
                ->select("address_country, address_country_name")
                ->from(LayoutWarehouse::getTableName())
                ->groupBy('address_country, address_country_name');
            ...
            $query->orderBy('address_country, address_country_name');
